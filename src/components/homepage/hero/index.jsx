    ...
    return (
        <div className="grid md:grid-cols-2 p-12">
           <div className="flex flex-col gap-4 pl-4">
                ...
                <p className="text-md font-semibold opacity-90">Read Html, Css, Bootstrap, JavaScript, Angular, React, Python, NodeJs, Php, Laravel, .Net, MongoDb, Aws Cloud, C++, Java.</p>
                <h1 className="text-5xl font-bold">Advanced Diploma In</h1>
                <h1 className="text-5xl font-bold text-[#3DA8E9]">In Software Engineering</h1>
           </div>
           <div className="bg-[#F9C6F3] p-6 w-[530px] h-[350px] mx-10 rounded-md">
