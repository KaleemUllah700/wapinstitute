    ...
    return (
        <Layout>
            <div className="flex flex-col items-center justify-center md:py-8 gap-2">
                <div className="flex flex-col items-center justify-center bg-[white] border border-xl shadow-lg md:p-6 p-4 md:w-[530px] w-[350px] md:h-[370px] h-[340px] rounded-md">
